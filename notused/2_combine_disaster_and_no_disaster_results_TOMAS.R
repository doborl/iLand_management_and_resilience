...
pdf(paste0(outroot, date,"disaster2_analyses_of_the_disaster_for_print.pdf"), height=8.3, width=11.7 )
...
g1<-ggplot(smean ,aes( factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED")),
                   mean.wind, 
                   fill=  factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED"))))+
  geom_col()+
  ...
  theme(panel.grid.major = element_blank(),
        ...
        strip.background =element_rect(fill="white"))
g1
g2<-ggplot(smean ,aes( factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED")),
                   mean.bb, 
                   fill=  factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED"))))+
  geom_col()+
  scale_fill_manual(values=(c("#4d9078", "#f2c14e", "#f78154",  "#b4436c", "#5fad56" )))+
...
g3<-ggplot(smean ,aes( factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED")),
                   mean.total, 
                   fill=  factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED"))))+
  geom_col()+
  scale_fill_manual(values=(c("#4d9078", "#f2c14e", "#f78154",  "#b4436c", "#5fad56" )))+
...
g4<-ggplot(lnd.vol ,aes( factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED")),
                         meanvol, 
                       fill=  factor(mgm, levels=c("ADAPTATION","BAU","BIOECONOMY","CONSERVATION", "UNMANAGED"))))+
  geom_col()+
